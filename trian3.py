...
class IPLWinPredictor:
    ...
    def predict_win_probability(self, match_info):
        ...
        try:
            ...
            # Corrected logic for identifying the chasing team
            ...
            if toss_decision == 'bat':
                ...
                batting_first_team = team1 if toss_winner != team1 else team2

            chasing_team = team2 if batting_first_team == team1 else team1
            chasing_team_index = 0 if chasing_team == team1 else 1
            ...
            # Dynamically clip based on game phase
            ...
            #beta_input = np.clip(chase_difficulty / 3.0, 0.0001, 0.9999)

            print(chase_difficulty)
            ...
            # Ensure safe input for beta.cdf
            beta_input = np.clip(chase_difficulty / 5, 0.0001, 0.9999)
...
def main():
    ...
    try:
        ...
        print(f"Error in simulation at over 20: {str(e)}")
